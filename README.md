...
`[https://theparascandagency.biz/request-call-back](https://theparascandagency.biz/request-call-back)`. Designed to be deployed on Railway
...
#         Location: [https://theparascandagency.biz/request-call-back](https://theparascandagency.biz/request-call-back)
```
...
5. Visit `https://theparascandagency.business` - it should 301 to
   `[https://theparascandagency.biz/request-call-back](https://theparascandagency.biz/request-call-back)`.
